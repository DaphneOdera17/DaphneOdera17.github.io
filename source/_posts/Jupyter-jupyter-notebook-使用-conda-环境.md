---
title: Jupyter | jupyter notebook 使用 conda 环境
aside: true
tags:
  - Jupyter Notebook
  - Anaconda
categories: Jupyter Notebook
keywords: 'Jupyter Notebook, conda'
description: jupyter notebook 中使用自己创建的 conda 环境作为内核
mathjax: true
abbrlink: 6548a155
date: 2024-10-01 18:05:22
updated:
top_img:
comments:
cover: https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/20241001181826.png
toc:
toc_number:
copyright:
copyright_author:
