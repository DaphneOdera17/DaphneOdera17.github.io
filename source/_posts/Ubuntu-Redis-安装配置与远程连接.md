---
title: Ubuntu | Redis | 安装配置与远程连接
aside: true
description: 记录 Birdy 在 Ubuntu 下进行 Redis 的配置以及用 vscode 远程连接。
cover: >-
  https://typora-birdy.oss-cn-guangzhou.aliyuncs.com/Snipaste_2025-04-14_00-02-00.png
mathjax: true
abbrlink: 625c5822
